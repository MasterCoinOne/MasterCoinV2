Contributing to MasterCoin Core
============================

The MasterCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MasterCoin Core project, and is not to be
confused with overall MasterCoin Network Protocol consensus changes.

Whether a pull request is merged into MasterCoin Core rests with the project merge
...
Patches that change MasterCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the MasterCoin consensus, it must have been
...
The project leader is the release manager for each MasterCoin Core release.
