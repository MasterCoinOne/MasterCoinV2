...
VERSION=
commit=false
url=https://github.com/mastercoin-project/mastercoin
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/mastercoin-project/mastercoin
...
then
	# Make output folder
	mkdir -p ./mastercoin-binaries/${VERSION}
	...
	then
	    ...
	    mv build/out/mastercoin-*.tar.gz build/out/src/mastercoin-*.tar.gz ../mastercoin-binaries/${VERSION}
	fi
	# Windows
	if [[ $windows = true ]]
	then
	    ...
	    mv build/out/mastercoin-*.zip build/out/mastercoin-*.exe ../mastercoin-binaries/${VERSION}
	fi
	# Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    mv build/out/mastercoin-*.tar.gz build/out/mastercoin-*.dmg ../mastercoin-binaries/${VERSION}
	fi
	popd
...
then
	...
	then
	    ...
	    mv build/out/mastercoin-*win64-setup.exe ../mastercoin-binaries/${VERSION}
	    mv build/out/mastercoin-*win32-setup.exe ../mastercoin-binaries/${VERSION}
	fi
	# Sign Mac OSX
	if [[ $osx = true ]]
	then
	    ...
	    mv build/out/mastercoin-osx-signed.dmg ../mastercoin-binaries/${VERSION}/mastercoin-${VERSION}-osx.dmg
	fi
	popd
