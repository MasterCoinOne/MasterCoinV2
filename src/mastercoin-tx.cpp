...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MasterCoin Core mastercoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mastercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mastercoin transaction") + "\n" +
                               "  mastercoin-tx [options] -create [commands]   " + _("Create hex-encoded mastercoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mastercoin transaction
