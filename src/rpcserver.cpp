...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MasterCoin features */
        {"mastercoin", "masternode", &masternode, true, true, false},
        {"mastercoin", "masternodelist", &masternodelist, true, true, false},
        {"mastercoin", "mnbudget", &mnbudget, true, true, false},
        {"mastercoin", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"mastercoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mastercoin", "mnsync", &mnsync, true, true, false},
        {"mastercoin", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"mastercoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mastercoind, or the -server option to mastercoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mastercoin-cli " + methodname + " " + args + "\n";
}
