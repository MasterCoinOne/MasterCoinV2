...
#if defined(NDEBUG)
#error "MasterCoin cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 72000 && nHeight > 62000) {
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 84000 && nHeight > 72000) {
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 114000 && nHeight > 84000) {
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 126000 && nHeight > 114000) {
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 156000 && nHeight > 126000) {
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 168000 && nHeight > 156000) {
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 198000 && nHeight > 168000) {
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 210000 && nHeight > 198000) {
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 240000 && nHeight > 210000) {
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 252000 && nHeight > 240000) {
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 282000 && nHeight > 252000) {
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 294000 && nHeight > 282000) {
        nSubsidy = 23 * COIN;
    } else if (nHeight <= 324000 && nHeight > 294000) {
        nSubsidy = 23 * COIN;		
    } else {
        nSubsidy = 23 * COIN;
    }
...
{
    RenameThread("mastercoin-scriptch");
