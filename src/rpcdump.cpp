...
Value dumpprivkey(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"mastercoinaddress\"   (string, required) The mastercoin address for the private key\n"
            "\nResult:\n"
...
Value bip38encrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38encrypt \"mastercoinaddress\"\n"
            "\nEncrypts a private key corresponding to 'mastercoinaddress'.\n"
            "\nArguments:\n"
            "1. \"mastercoinaddress\"   (string, required) The mastercoin address for the private key (you must hold the key already)\n"
...
Value bip38decrypt(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "bip38decrypt \"mastercoinaddress\"\n"
