/* src/config/mastercoin-config.h.  Generated from mastercoin-config.h.in by configure.  */
/* src/config/mastercoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.mastercoin.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MasterCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MasterCoin Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mastercoin"
