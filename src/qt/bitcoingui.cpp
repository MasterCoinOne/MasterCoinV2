                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MasterCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MasterCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mastercoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MasterCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MasterCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MasterCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MasterCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MasterCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a MasterCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MasterCoin Core help message to get a list with possible MasterCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MasterCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("MasterCoin Core"); // default title
