...
In order to support loading of multiple wallets in mastercoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mastercoin.cpp.
...
Changes to mastercoin.cpp
----------------------
mastercoin.cpp is the entry point into mastercoin-qt, and as such, will require some minor modifications to provide hooks for
