MasterCoin Core version 2.2.1 is now available from:

  <https://github.com/mastercoin-project/mastercoin/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/mastercoin-project/mastercoin/issues>

Compatibility
==============

MasterCoin Core is extensively tested on multiple operating systems using
...
MasterCoin Core should also work on most other Unix-like systems but is not
...
of Bitcoin that MasterCoin was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/mastercoin-project-translations/).
