...
pkgdatadir = $(datadir)/mastercoin
pkgincludedir = $(includedir)/mastercoin
pkglibdir = $(libdir)/mastercoin
pkglibexecdir = $(libexecdir)/mastercoin
...
CONFIG_HEADER = $(top_builddir)/src/config/mastercoin-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/mastercoin-config.h.in \
...
ACLOCAL = ${SHELL} /home/talium/coins/Mastercoin/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/talium/coins/Mastercoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/talium/coins/Mastercoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/talium/coins/Mastercoin/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/talium/coins/Mastercoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = mastercoin
PACKAGE_BUGREPORT = www.mastercoin.com
PACKAGE_NAME = MasterCoin Core
PACKAGE_STRING = MasterCoin Core 1.1.0
PACKAGE_TARNAME = mastercoin
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/talium/coins/Mastercoin
abs_srcdir = /home/talium/coins/Mastercoin
abs_top_builddir = /home/talium/coins/Mastercoin
abs_top_srcdir = /home/talium/coins/Mastercoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/talium/coins/Mastercoin/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/mastercoind$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/mastercoin-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/mastercoin-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = MasterCoin-Qt.app
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_mastercoin_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_mastercoin_coverage.info test_mastercoin.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/MasterCoin-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/mastercoin-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/mastercoin-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/mastercoin-config.h
$(top_srcdir)/src/config/mastercoin-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/mastercoin-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/MasterCoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MasterCoin-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/MasterCoin-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_mastercoin.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_mastercoin -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_mastercoin_filtered.info: test_mastercoin.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_mastercoin_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_mastercoin_coverage.info: baseline_filtered_combined.info test_mastercoin_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_mastercoin_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_mastercoin_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_mastercoin_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_mastercoin.coverage/.dirstamp:  test_mastercoin_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_mastercoin.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local:
	rm -rf test_mastercoin.coverage/ total.coverage/ $(OSX_APP)
